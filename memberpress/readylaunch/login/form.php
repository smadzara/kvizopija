...
<div id="mepro-login-hero" class="<?php echo $show_welcome_image ? 'with-sidebar' : ''; ?>">
  <div class="mepro-boxed">
    <div class="mepro-login-contents">
      ...
      <div id="mepr-template-login" class="mp_wrapper mp_login_form<?php echo (!empty($is_login_page) || (!empty($login_page_id) && is_page((int) $login_page_id))) ? ' mp_login_form--page' : ''; ?>">
        ...
        <?php else : ?>
          ...
          <div class="mp-spacer">&nbsp;</div>
          <?php
          $register_url = apply_filters('kvizopija_memberpress_register_url', '', $atts ?? []);

          if (is_wp_error($register_url) || !is_string($register_url)) {
              $register_url = '';
          }
          ...
          if (empty($register_url)) {
              ...
              if (!empty($group_ids)) {
                  $register_url = get_permalink((int) $group_ids[0]);
              }
          }
          ...
          if (empty($register_url)) {
              ...
              if (!empty($membership_ids)) {
                  $register_url = get_permalink((int) $membership_ids[0]);
              }
          }
          ?>
          <div class="mepr-login-actions">
            ...
            <?php if (!empty($register_url)) : ?>
              <a
                ...
                class="mepr-login-register-link"
              >
                <?php echo esc_html_x('Register', 'ui', 'memberpress'); ?>
              </a>
            <?php endif; ?>
          </div>
