...
if ($questions_and_answers) {
    ...
    foreach ($questions_and_answers as $index => $qa) {
        ...
        echo '<input type="checkbox" name="check_answer_' . $index . '"> Provjeri točnost odgovora<br>';
...
// Pokrenite timer kada se stranica učita
window.onload = startTimer;

// Zaustavite timer kada korisnik klikne na gumb "Prikaži odgovore"
